...
// import {
//   fetchGoodsPhotoList,//获取列表
//   fetchDeleteGoodsPhoto,
// } from 'actions/goods'
...
// @connect(
//   (state, props) => ({
//     goodsPhotoListSearchResult: state.goodsPhotoListSearchResult
//   })
// )
//
//
...
//
//   componentDidMount() {
//     const goodsId = this.props.goodsId || this.props.params.goodsId || 1;
//     this.getList(goodsId)
//   }
//
//   getList(goodsId) {
//     this.props.dispatch(fetchGoodsPhotoList({wpId: goodsId}, ()=> {
//       this.setState({
//         path:this.props.goodsPhotoListSearchResult.path,
...
//       this.getList(this.regular.goodsId);
//     }
//   }
//
//   // 删除在线图片
...
//       content: '是否确认删除此图片？',
//       onOk(){
//         self.props.dispatch(fetchDeleteGoodsPhoto({id: value.id}, (response)=> {
...
//     var self = this
//     var url = $GLOBALCONFIG.$ctx + '/jcjw/article/addPicture.json'
//     console.log(url)

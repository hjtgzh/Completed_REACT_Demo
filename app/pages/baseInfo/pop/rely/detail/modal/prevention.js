      ...
      <div className="content" >
        ...
        >
          ...
          <Row gutter={16}>
            ...
            <Col span="12">
              <FormItem {...formItemLayout} label="聘用时间 ">
                {getFieldDecorator('pysj')(
                  <Input type="text" name="pysj" />
                )}
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem {...formItemLayout} label="解聘时间  ">
                {getFieldDecorator('jpsj')(
                  <Input type="text" name="jpsj" />
                )}
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem {...formItemLayout} label="协辅警编号 ">
                {getFieldDecorator('xfjbh')(
                  <Input type="text" maxLength="20" name="xfjbh" />
                )}
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem {...formItemLayout} label="使用部位">
                {getFieldDecorator('sybw')(
                  <Select name="sybw"
                    id="department"
                    size="large"
                  >
                    <Option value="">请选择</Option>
                    <Option value="1">派出所内部管理</Option>
                    <Option value="2">社会面巡逻</Option>
                    <Option value="3">专业反扒</Option>
                    <Option value="4">流动人口管理</Option>
                    <Option value="5">安全防范宣传</Option>
                    <Option value="6">纠纷调解</Option>

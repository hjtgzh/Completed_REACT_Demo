      ...
      <div className="content" >
        ...
        >
          ...
          <Row gutter={16}>
            ...
            <Col span="12">
              <FormItem {...formItemLayout} label="服务区、县(市)  ">
                {getFieldDecorator('fwqx')(
                  <Input type="text" maxLength="20" name="fwqx" />
                )}
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem {...formItemLayout} label="服务乡镇(街道)  ">
                {getFieldDecorator('fwjd')(
                  <Input type="text" maxLength="20" name="fwjd" />
                )}
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem {...formItemLayout} label="服务村(社区)   ">
                {getFieldDecorator('fwsq')(
                  <Input type="text" maxLength="20" name="fwsq" />
                )}
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem {...formItemLayout} label="服务岗位">
                {getFieldDecorator('fwgw')(
                  <Select
                    id="server"
                    size="large"
                  >
                    <Option value="">请选择</Option>
                    <Option value="1">楼道长、单元长等信息员</Option>
                    <Option value="2">制高点守护</Option>
                    <Option value="3">路面巡逻</Option>
                    <Option value="4">安全宣传</Option>
                    <Option value="5">机动支援</Option>
                    <Option value="6">其他安保岗位</Option>
                  </Select>
                )}
              </FormItem>
            </Col>
        ...
        <div className="ability-button">
          ...
          {/* <Popconfirm title="是否删除" onconfirm={this.props.deleteModal}>*/}
